    ...
    if (isEditing) {
      ...
      setTimeout(() => {
        setFormData({
          ...
          descripcion: "Ven a conocer nuestras carreras, laboratorios y a nuestros docentes en este evento especial.",
          fecha_inicio: "2024-03-15T09:00",
          fecha_fin: "2024-03-15T18:00",
